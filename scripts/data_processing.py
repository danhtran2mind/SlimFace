...
def process_image(src_path, dest_dir_raw, dest_dir_aug, aug=None):
    """
    ...
    Args:
        ...
        dest_dir_raw (str): Destination directory for the raw processed image
        dest_dir_aug (str): Destination directory for the augmented image
    ...
    try:
        ...
        raw_dest_path = os.path.join(dest_dir_raw, os.path.basename(src_path))
        ...
        if aug:
            ...
            aug_dest_path = os.path.join(dest_dir_aug, f"aug_{os.path.basename(src_path)}")
