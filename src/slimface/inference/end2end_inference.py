...
if __name__ == "__main__":
    ...
    parser.add_argument('--reference_dict_path', type=str, default='data/reference_data/reference_image_data.json', help='Path to JSON file mapping classes to reference image paths.')
    parser.add_argument('--index_to_class_mapping_path', type=str, default='ckpts/index_to_class_mapping.json', help='Path to index-to-class JSON.')
    parser.add_argument('--model_path', type=str, default='ckpts/SlimFace_efficientnet_b3_full_model.pth', help='Path to classifier model (.pth).')
    ...
    parser.add_argument('--similarity_threshold', type=float, default=0.3, help='Cosine similarity threshold.')
