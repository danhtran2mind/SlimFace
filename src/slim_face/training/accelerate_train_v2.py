...
class FaceDataset(Dataset):
    def __init__(self, root_dir, transform=None, algorithm='yolo'):
...
def main(args):
    ...
    val_dataset = FaceDataset(root_dir=os.path.join(args.dataset_dir, "val_data"), transform=transform, algorithm=args.algorithm)
